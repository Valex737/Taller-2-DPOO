...
public class SandboxArreglos
{
    ...
    public void organizarEnteros( )
    {
    	for (int i = 0; i < arregloEnteros.length; i++)
        {
            for (int j = i + 1; j < arregloEnteros.length; j++)
            {
                ...
                {
                    int nemo = arregloEnteros[i];
                    arregloEnteros[i] = arregloEnteros[j];
                    arregloEnteros[j] = nemo;
                }
            }
        }
    }
    ...
    public void organizarCadenas( )
    {
    	for (int i = 0; i < arregloCadenas.length; i++)
        {
            for (int j = i + 1; j < arregloCadenas.length; j++)
            {
                ...
                {
                    String nemo = arregloCadenas[i];
                    arregloCadenas[i] = arregloCadenas[j];
                    arregloCadenas[j] = nemo;
                }
            }
        }
    }
    ...
    {
    	int vale = contarApariciones(valor);
        int[] posiciones = new int[vale];
    ...
    {
    	if (otroArreglo == null || otroArreglo.length != arregloEnteros.length)
            return false;
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        arregloEnteros = copia1;
        organizarEnteros();
        copia1 = getCopiaEnteros();

        arregloEnteros = copia2;
        organizarEnteros();
        copia2 = getCopiaEnteros();
